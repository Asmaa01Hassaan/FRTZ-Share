...
class PortalDashboard(http.Controller):
    ...
    def portal_dashboard(self, page='index', **kw):
        ...
        return request.render('crm_task_link.my_custom_dashboard', values)
    ...
    def portal_project_view(self, project_id, **kw):
        ...
        return request.render('crm_task_link.template_project_view', {
            'project': project,
        })
    ...
    def portal_create_invoice(self, project_id=None, **kw):
        ...
        return request.render('crm_task_link.template_invoice_create', values)
    ...
    def portal_project_invoices(self, project_id=None, **kw):
        ...
        return request.render('crm_task_link.template_project_invoices_list', {
            'project': project,
            'invoices': invoices,
        })
    ...
    def portal_sale_order_create(self, project_id=None, **kw):
        project = request.env['project.project'].browse(int(project_id))
        return request.render('crm_task_link.template_sale_order_create', {
            'project': project,
            'partner': project.partner_id,
        })
    ...
    def portal_project_sale_orders(self, project_id=None, **kw):
        ...
        return request.render('crm_task_link.template_project_sale_orders', {
            'project': project,
